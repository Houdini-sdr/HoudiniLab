...
class RecorderThread {
 public:
  RecorderThread(std::unique_ptr<RecorderWorkerInterface> worker,
                 size_t packet_data_length, size_t thread_id, int core,
 ...
 private:
  ...
  std::unique_ptr<RecorderWorkerInterface> worker_;
  std::thread thread_;
